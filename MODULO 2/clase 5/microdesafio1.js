...
function alquilerDeUnVehiculo(tipoDeVehiculo, diasDeAlquiler, sillaParaBebeDeseada) {
    const costoVehiculo = precio[tipoDeVehiculo];
    const costoSilla = sillaParaBebeDeseada ? sillaParaBebe : 0;
    const montoTotal = costoVehiculo * diasDeAlquiler + costoSilla;
